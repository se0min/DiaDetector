...
namespace AutoAssembler
{
    public partial class frmDIOSetting : Form
    {
        ...
        {
            // 초기화 ...
            lstOutputView.Columns.Add("접점 번호", 100, HorizontalAlignment.Center);
            lstOutputView.Columns.Add("이름", 199, HorizontalAlignment.Center);

            lstInputView.Columns.Add("접점 번호", 100, HorizontalAlignment.Center);
            lstInputView.Columns.Add("이름", 199, HorizontalAlignment.Center);
        ...
        private void OutputListReDrawList()
        {
            ...
            {
                ListViewItem lstViewTestItem = new ListViewItem((i-64).ToString());
...
#region Data 관리 ...
        ...
        private void txtOutputName_TextChanged(object sender, EventArgs e)
        {
            if (lstOutputView.SelectedItems.Count == 1)
            {
                int index = lstOutputView.SelectedIndices[0] + 64;
