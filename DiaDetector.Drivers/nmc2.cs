...
namespace DiaDetector.Drivers
{
    public class NMC2
    {
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetAxesDriveSpeed(short nNmcNo, out double pDrvSpeed);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetParaLogicFile(short nNmcNo, out char pStr);
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_MultiAxisStop(short nNmcNo, short nCount, out short pnAxisSelect, short nMode);
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetAxesExpress(short nNmcNo, out NMCAXESEXPR pNmcData);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetStopInfo(short nNmcNo, out short pnStopMode);
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMultiCurrentOn(short nNmcNo, short nCount, out short pnAxisSelect, short nOut);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMultiServoOn(short nNmcNo, short nCount, out short pnAxisSelect, short nOut);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMultiAlarmOn(short nNmcNo, short nCount, out short pnAxisSelect, short nOut);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMultiDccOn(short nNmcNo, short nCount, out short pnAxisSelect, short nOut);
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetSync(short nNmcNo, short nGroupNo, out short pnSyncGrpList0, out short pnSyncGrpList1);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMDIOOutPins(short nNmcNo, short nCount, out short pnPinNo, out short pnStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMDIOOutTogPins(short nNmcNo, short nCount, out short pnPinNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetMDIOInPin(short nNmcNo, short nPinNo, out short pnInStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_GetMDIOInput(short nNmcNo, out short pnInStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetMDIOInputBit(short nNmcNo, short nBitNo, out short pnInStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetMDIOOutput(short nNmcNo, out short pnOutStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMDIOOutput(short nNmcNo, out short pnOutStatus);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMDIOOutputAll(short nNmcNo, out short pnOnBitNo, out short pnOffBitNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMDIOOutputTogAll(short nNmcNo, out short pnBitNo);
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetMDIOOutput32(short nNmcNo, out int lOutStatus);

        //-----------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutPin(short nNmcNo, short nPinNo, out short nOutStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutTogPin(short nNmcNo, short nPinNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutPins(short nNmcNo, short nCount, out short pnPinNo, out short pnStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutTogPins(short nNmcNo, short nCount, out short pnPinNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetDIOInPin(short nNmcNo, short nPinNo, out short pnInStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_GetDIOInput(short nNmcNo, out short pnInStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetDIOInput128(short nNmcNo, out short pnInStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetDIOInputBit(short nNmcNo, short nBitNo, out short pnInStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_GetDIOOutput(short nNmcNo, out short pnOutStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetDIOOutput128(short nNmcNo, out short pnOutStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutput(short nNmcNo, out short pnOutStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutput128(short nNmcNo, out short pnOutStatus);
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutputAll(short nNmcNo, out short pnOnBitNo, out short pnOffBitNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutputTogAll(short nNmcNo, out short pnBitNo);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutput64(short nNmcNo, out long lOutStatus);
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetDIOOutput32(short nNmcNo, short nIndex, out int lOutStatus);
        //-----------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetEXDIOOutPins(short nNmcNo, short nCount, out short pnPinNo, out short pnStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetEXDIOOutTogPins(short nNmcNo, short nCount, out short pnPinNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetEXDIOInPin(short nNmcNo, short nPinNo, out short pnInStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_GetEXDIOInput(short nNmcNo, out short pnInStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetEXDIOInputBit(short nNmcNo, short nBitNo, out short pnInStatus);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetEXDIOOutput(short nNmcNo, out short pnOutStatus);

        [DllImport("NMC2.dll")]
        public static extern short nmc_SetEXDIOOutput(short nNmcNo, out short pnOutStatus);
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetEXDIOOutputAll(short nNmcNo, out short pnOnBitNo, out short pnOffBitNo);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetEXDIOOutputTogAll(short nNmcNo, out short pnBitNo);
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SetEXDIOOutput32(short nNmcNo, out int lOutStatus);
        //-----------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetUnitPerPulseAll(short nNmcNo, out double pdRatio);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_WriteIPAddress(short nNmcNo, out short pnIP, out short pnSubNet, short nGateway);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetBusyStatusAll(short nNmcNo, out short pnBusyStatus);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetMapIO(short nNmcNo, out short pnMapInStatus);
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetAxesCmdSpeed(short nNmcNo, out double pDrvSpeed);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetAxesEncSpeed(short nNmcNo, out double pdEncSpeed);
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetAxesCmdEncSpeed(short nNmcNo, out double pdCmdSpeed, out double pdEncSpeed);
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_GetGantryInfo(short nNmcNo, out short pnEnable, out short pnMainAxes, out short pnSubAxes);
        //------------------------------------------------------------------------------
        [DllImport("NMC2.dll")]
        ...
        [DllImport("NMC2.dll")]
        public static extern short nmc_SerialWrite(short nNmcNo, short nLen, out char pStr);
        [DllImport("NMC2.dll")]
        public static extern short nmc_SerialRead(short nNmcNo, out short pnReadLen, out char pReadStr);
