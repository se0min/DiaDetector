...
#region PAIX ...
        ...
        public bool Open(short dev_no)
        {
            ...
            /*
            NMC2.nmc_SetIPAddress(dev_no, 
                DeviceManager.g_ndevIdA_1, 
                DeviceManager.g_ndevIdA_2, 
                DeviceManager.g_ndevIdA_3);
            */


            // 방화벽을 확인해 주십시요.
            if (NMC2.nmc_PingCheck(dev_no, 250) != 0)
            {
        ...
        */
        ...
        public bool SetEncInputMode(short nAxis, short nMode)
        {
            ...
            short nRet = NMC2.nmc_SetEncoderMode(m_nDev_no, nAxis, nMode);
            switch (nRet)
            {
                case NMC2.NMC_NOTCONNECT:
                    m_bIsOpen = false;
        ...
        public bool ContTest()
        {
            ...
            while (true)
            {
                ...
                nExeNo = NmcContiStatus.nContiExecutionNum[GROUP];
